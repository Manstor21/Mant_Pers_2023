package javaapplication5.MantPersona.src.mantPersona;
...
public class MantPersona {
	...
	void bajas() throws IOException{
		...
		p.leerPersona(fich);
		if(p.getNumero() == 0)
			System.out.println("\nLa persona con el número: "+numBus+" no existe.\n");
		else{
			p.verDatosPersona(0);
			do{
	...
	void consultas()throws IOException{
		...
		if(p.getNumero() != 0)
			...
			System.out.println("\nNo existe ninguna persona con el numero: "+numBus+" en el fichero.\n");
		fich.close();
	...
	void listados()throws IOException{
		...
		do{
			...
			if (cl==LINEAS){
				System.out.println("\nMedia de edad página...................:"+sumaEdadP/cl);
				sumaEdadG+=sumaEdadP;
				sumaEdadP = 0;
				System.out.println("\n\tPulse <Intro> para continuar....");
				t.leerSalto();
